    ...
    .then(function(Pipes){
      ...
      Pipes.forEach(function(Pipe){
        ...
        Pipe.post.images.forEach(function(Image, index){
          ...
          image_subitem.append('<a href="/'+current_user_id+'/post/'+Pipe.post._id+'/image/'+index+'"><img width=500px src="data:image/png;base64,'+Image["base64"]+'"></a>')
        ...
        var comment = $('<div class="main-section-item-qty-price-comments-subitem"><a href="/'+current_user_id+'/post/'+Pipe.post._id+'/comment">Comments</a></div>')
        var share = $('<div class="main-section-item-qty-price-comments-subitem"><a href="/'+current_user_id+'/post/'+Pipe.post._id+'/share">Share</a></div>')
        ...
        var block_form = $('<form action="/'+current_user_id+'/post/'+Pipe.post._id+'/block" method="POST"></form>')
        ...
        $('#display_posts').prepend(main_section_item)
