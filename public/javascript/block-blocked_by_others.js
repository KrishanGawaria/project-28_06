...
function process() {
  ...
  $.get('/api/blocked-by-others/'+skip.toString())
  .then(function(Posts){
    ...
    Posts.forEach(function(Post){
      ...
      var post_author = $('<div class="main-section-item-author main-section-subitem">Buyer - <a href="#">'+Post.author.username+'</a></div>')
      ...
      var performa_order = $('<div class="main-section-item-qty-price-comments main-section-subitem"></div>')
      var send_performa = $('<div class="main-section-item-qty-price-comments-subitem"><a href="#">Send Performa</a></div>')
      var see_order = $('<div class="main-section-item-qty-price-comments-subitem"><a href="#">See Order</a></div>')

      performa_order.append(send_performa)
      performa_order.append(see_order)
      ...
      main_section_item.append(performa_order)
