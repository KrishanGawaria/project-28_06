...
function process() {
  ...
  $.get('/api/blocked-by-me/'+skip.toString())
  .then(function(Posts){
    ...
    Posts.forEach(function(Post){
      ...
      var post_author = $('<div class="main-section-item-author main-section-subitem">Seller - <a href="#">'+Post.seller.username+'</a></div>')
      ...
      var see_performa = $('<div class="main-section-item-qty-price-comments-subitem"><a href="#">See Performa</a></div>')
      var order = $('<div class="main-section-item-qty-price-comments-subitem"><a href="#">Order</a></div>')

      performa_order.append(see_performa)
      performa_order.append(order)
